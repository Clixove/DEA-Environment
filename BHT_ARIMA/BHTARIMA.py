...
class BHTARIMA(object):
    ...
    def __init__(self, ts, p, d, q, taus, Rs, K, tol, seed=None, Us_mode=4,
        ...
        self._d = d  # d-order
        self._q = q  # q-order
        self._taus = taus  # MDT-rank
        self._Rs = Rs  # tucker decomposition ranks
        self._K = K  # iterations
        self._tol = tol  # stop criterion
        self._Us_mode = Us_mode  # orthogonality mode
